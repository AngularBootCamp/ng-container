# DRAFT - Angular Boot Camp Curriculum - ng-container
...
[StackBlitz for ng-container](https://stackblitz.io/github/AngularBootCamp/ng-container)

Alternatively, you can clone the repository locally and run the
following commands:

```
git clone git@github.com:AngularBootCamp/ng-container.git
cd ng-container
yarn
yarn start
```
